cfgs=( # for first two repeats of Spasm+RWpair
"/slurm-storage/linbao/thesis_code_1/GRIT/configs/HomBias/repeats/Spasm+RWpair/hom+rwpair.yaml"
)

seeds=(0 14)

#XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
#CHANGE PARTITION BACK TO MEDIUM IF USE THIS FOR PT 2
#XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
